...
app.use((0, cors_1.default)({ origin: ['http://localhost:3000', 'https://attribution-booster-frontend.netlify.app', 'https://www.attributionbooster.com', 'https://attributionbooster.com'], credentials: true }));
// Root route
app.get('/', (req, res) => {
